...
import * as sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: CkP7MMho2GgB/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__z7Caw)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column___3H0Nl)}>
            <h5
