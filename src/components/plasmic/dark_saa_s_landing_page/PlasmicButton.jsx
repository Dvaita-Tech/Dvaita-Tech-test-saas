...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: 6aP2U4alYtJI/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__lFn2U)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__viOpe)}
                role={"img"}
              />
            ),
